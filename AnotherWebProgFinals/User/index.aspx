...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col m7 center">
            <div class="slider">
                <ul class="slides">
                    <li>
                        <img class="responsive-img" style="width: 100%" src="../images/background1.jpg">
                        <!-- random image -->
                    </li>
                    <li>
                        <img class="responsive-img" style="width: 100%" src="../images/church.jpg">
                        <!-- random image -->
                    </li>
                    <li>
                        <img class="responsive-img" style="width: 100%" src="../images/lpu.png">
                        <!-- random image -->
                    </li>
                    <li>
                        <img class="responsive-img" style="width: 100%" src="../images/background2.jpg">
                        <!-- random image -->
                    </li>
                </ul>
            </div>
    ...
    <div class="row dirtywhite">
        <div class="col m6 s12">
            <ul id="task-card" class="collection with-header animated zoomInUp z-depth-2">
                <li class="collection-header light-blue accent-4">
                ...
                <div class="row">
                    <div class="col m6 s12 center animated fadeInLeft">
                        ...
                        <asp:FormView ID="CityMissionFormView" runat="server" DataSourceID="CityMissionDataSource">
                            <ItemTemplate>
                                <h1 class="center light-blue-text accent-2" style="font-weight: 600; font-size: 4em">MISSION</h1>
                                <p style="text-align: center" class="center light-blue-text accent-2">
                    ...
                    <div class="col m6 s12 center animated fadeInRight">
                        ...
                        <asp:FormView ID="CityVisionFormView" runat="server" DataSourceID="CityVisionDataSource">
                            <ItemTemplate>
                                <h1 class="center light-blue-text accent-2" style="font-weight: 600; font-size: 4em">VISION</h1>
                                <p style="text-align: center" class="center light-blue-text accent-2">
    ...
    <div class="container">
        <h1 class="center">Where Having Fun Has A New Meaning</h1>
        <div class="row">
            <div class="col m6 center">
                <img src="../images/valfes.jpg" style="width: 100%; height: 50%" class="responsive-img" />
            </div>
            <div class="col m6 center">
                <h1 class="light-blue-text">Valenciana Festival</h1>
        ...
        <div class="row">
            <h1 class="center">A Taste of Our Distinct Culture</h1>
            <div class="col m6 center">
                <h1 class="light-blue-text">Kasilyo(Kesong Puti)</h1>
        ...
        <div class="row">
            ...
            <div class="col m6 center">
                <h1 class="light-blue-text">Valenciana</h1>
